...
TARGET_KERNEL_SOURCE := kernel/asus/X00H
...
# Assert
TARGET_OTA_ASSERT_DEVICE := X00H

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 47538176 # This is the maximum known partition size, but it can be higher, so we just omit it
